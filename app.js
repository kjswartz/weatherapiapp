...
function getLocationAndWeather(){
  ...
  */
    ...
    xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getlocationandweather.php?owapikey=3dad97af52b30ccf8cc6fa41be4337c5&units=imperial", true);
    xhr.send();
...
function getWeatherForLocation(){
  ...
  if (location != null){
    ...
    xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getweatherforlocation.php?owapikey=3dad97af52b30ccf8cc6fa41be4337c5&units=metric&location=" + location, true);
    xhr.send();
  }
  else{
    alert("Unable to fetch the location and weather data.");
...
function loadBackground(lat, lon, weatherTag) {
  ...
  script_element.src = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=4195d0613a776f9fffdb600ae107306b&lat=" + lat + "&lon=" + lon + "&accuracy=1&tags=" + weatherTag + "&sort=relevance&extras=url_l&format=json";
